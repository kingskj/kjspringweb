...
final class MyBatisMapperProxyClassVisitor extends ClassVisitor {
    ...
    MyBatisMapperProxyClassVisitor(ClassVisitor cv, String targetMethod, String targetDescriptor) {
        ...
        if (targetMethod.equals(name) && targetDescriptor.equals(descriptor)) {
            ...
            MethodVisitor targetMethodVisitor = reorderAgentCatchAll
                    ? new AgentCatchAllReorderingMethodNode(
                            ...
                            handlerLabel)
                    : mv;
            return new MyBatisMapperProxyInvokeAdapter(targetMethodVisitor, access, name, descriptor, handlerLabel);
        }
        return mv;
    }
}
